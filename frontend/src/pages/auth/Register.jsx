    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 py-8">
      <div className="max-w-md w-full glass-card p-6 sm:p-10 rounded-2xl sm:rounded-3xl">
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-slate-500 mt-2 text-sm sm:text-base">Start your journey to TCS NQT success</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          <div>
            <label className="block text-sm font-semibold text-slate-700 mb-1.5 sm:mb-2">Full Name</label>
            <div className="relative">
              <User className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
              <input
                type="text"
                required
                className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-4 bg-slate-50 border border-slate-200 rounded-xl sm:rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all text-sm sm:text-base"
